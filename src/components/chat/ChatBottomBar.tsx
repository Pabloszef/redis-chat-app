            ...
            <AnimatePresence>
                ...
                >
                    <Textarea
                        ...
                        placeholder="Aa"
                        rows={1}
                        className="w-full rounded-full border flex items-center h-9 resize-none overflow-hidden bg-background min-h-0"
                        value={message}
                        onChange={(e) => {
                ...
                {message.trim() ? (
                    <Button
                        className="size-9 dark:bg-muted dark:text-muted-foreground
                        dark:hover:bg-muted dark:hover:text-white shrink-0"
                        variant={"ghost"}
                        size="icon"
                    >
                    ...
                    <Button
                        ...
                        size="icon"
                    >
                        {!isPending && <ThumbsUp className="text-muted-foreground" size={20}/>}
